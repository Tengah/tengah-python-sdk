...
extern NSString *const TE_METADATA_ATTRIBUTE_KINDS_LOCCOORD;
extern NSString *const TE_METADATA_ATTRIBUTE_KINDS_LOCNAME;
extern NSString *const TE_METADATA_ATTRIBUTE_KINDS_NAME;
extern NSString *const TE_METADATA_ATTRIBUTE_KINDS_PHONE;
extern NSString *const TE_METADATA_ATTRIBUTE_KINDS_TAG;
extern NSString *const TE_METADATA_ATTRIBUTE_KINDS_TEXT;
extern NSString *const TE_METADATA_ATTRIBUTE_KINDS_URL;
extern NSString *const TE_METADATA_ATTRIBUTE_KINDS_USERID;
